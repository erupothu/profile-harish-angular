...
export class DocumentationService {
  ...
  versionControll = [
    {
      id: 4, name: 'release4', version: 'v3.1.1', date: '01-05-2020', features: [
         { type: 'new', color: 'green', list: ['custom editor', 'blog profile'] },
        { type: 'imporved', color: 'blue', list: ['alignments', 'Responsive design imporved', 'rearrage navbar items'] },
